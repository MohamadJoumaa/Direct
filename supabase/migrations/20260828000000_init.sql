...
create table public.company_settings (
  ...
  night_surcharge_lbp numeric(12,0) not null default 89000,
  whish_number text not null default '81848663',
  fare_min_km numeric(8,2) not null default 3,
  fare_max_km numeric(8,2) not null default 150,
  fare_min_usd numeric(10,2) not null default 2.24,
  fare_max_usd numeric(10,2) not null default 10,
  fare_min_lbp numeric(12,0) not null default 200000,
  fare_max_lbp numeric(12,0) not null default 890000,
  multiplier_normal numeric(8,2) not null default 1,
  multiplier_long_distance numeric(8,2) not null default 1.1,
  multiplier_trusted numeric(8,2) not null default 1.4,
  multiplier_private numeric(8,2) not null default 3.5,
  multiplier_owner numeric(8,2) not null default 1.2,
  multiplier_medical numeric(8,2) not null default 2,
...
create table public.orders (
  ...
  delivery_fee_lbp numeric(12,0) not null default 0,
